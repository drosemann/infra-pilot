...
export default function AuditorPortalScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Auditor Portal Item 1", status: "active", detail: "Sample detail for Auditor Portal" },
    { id: "2", title: "Auditor Portal Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Auditor Portal</Text>

...
export default function VendorComplianceScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Vendor Compliance Item 1", status: "active", detail: "Sample detail for Vendor Compliance" },
    { id: "2", title: "Vendor Compliance Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Vendor Compliance</Text>

...
export default function AdoptionAnalyticsScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Adoption Analytics Item 1", status: "active", detail: "Sample detail for Adoption Analytics" },
    { id: "2", title: "Adoption Analytics Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

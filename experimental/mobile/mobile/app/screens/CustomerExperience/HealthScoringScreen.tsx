...
export default function HealthScoringScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Health Scoring Item 1", status: "active", detail: "Sample detail for Health Scoring" },
    { id: "2", title: "Health Scoring Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Health Scoring</Text>

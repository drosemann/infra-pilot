...
export default function NPSSurveysScreen() {
  const [data, setData] = useState([
    { id: "1", title: "NPS Surveys Item 1", status: "active", detail: "Sample detail for NPS Surveys" },
    { id: "2", title: "NPS Surveys Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>NPS Surveys</Text>

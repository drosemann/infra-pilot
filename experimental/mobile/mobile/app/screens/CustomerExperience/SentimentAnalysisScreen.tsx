...
export default function SentimentAnalysisScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Sentiment Analysis Item 1", status: "active", detail: "Sample detail for Sentiment Analysis" },
    { id: "2", title: "Sentiment Analysis Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

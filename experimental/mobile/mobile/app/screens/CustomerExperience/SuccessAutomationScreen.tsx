...
export default function SuccessAutomationScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Success Automation Item 1", status: "active", detail: "Sample detail for Success Automation" },
    { id: "2", title: "Success Automation Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Success Automation</Text>

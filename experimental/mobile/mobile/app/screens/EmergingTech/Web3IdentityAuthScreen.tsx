...
export default function Web3IdentityAuthScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Web3 Identity & Auth Item 1", status: "active", detail: "Sample detail for Web3 Identity & Auth" },
    { id: "2", title: "Web3 Identity & Auth Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Web3 Identity & Auth</Text>

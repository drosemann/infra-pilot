...
export default function APICatalogScreen() {
  const [data, setData] = useState([
    { id: "1", title: "API Catalog Item 1", status: "active", detail: "Sample detail for API Catalog" },
    { id: "2", title: "API Catalog Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

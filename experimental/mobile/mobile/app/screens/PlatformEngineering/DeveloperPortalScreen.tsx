...
export default function DeveloperPortalScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Developer Portal Item 1", status: "active", detail: "Sample detail for Developer Portal" },
    { id: "2", title: "Developer Portal Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

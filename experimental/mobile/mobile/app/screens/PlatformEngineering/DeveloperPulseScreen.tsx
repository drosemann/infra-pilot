...
export default function DeveloperPulseScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Developer Pulse Item 1", status: "active", detail: "Sample detail for Developer Pulse" },
    { id: "2", title: "Developer Pulse Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

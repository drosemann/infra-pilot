...
export default function GoldenPathScaffolderScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Golden Path Scaffolder Item 1", status: "active", detail: "Sample detail for Golden Path Scaffolder" },
    { id: "2", title: "Golden Path Scaffolder Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

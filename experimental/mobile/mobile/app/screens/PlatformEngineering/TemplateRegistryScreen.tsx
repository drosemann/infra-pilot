...
export default function TemplateRegistryScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Template Registry Item 1", status: "active", detail: "Sample detail for Template Registry" },
    { id: "2", title: "Template Registry Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

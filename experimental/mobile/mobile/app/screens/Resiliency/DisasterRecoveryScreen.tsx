...
export default function DisasterRecoveryScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Disaster Recovery Orchestrator Item 1", status: "active", detail: "Sample detail for Disaster Recovery Orchestrator" },
    { id: "2", title: "Disaster Recovery Orchestrator Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Disaster Recovery Orchestrator</Text>

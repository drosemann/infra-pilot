...
export default function AttestationReportsScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Attestation Reports Item 1", status: "active", detail: "Sample detail for Attestation Reports" },
    { id: "2", title: "Attestation Reports Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Attestation Reports</Text>

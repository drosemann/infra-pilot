...
export default function AuditManagementScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Audit Management Item 1", status: "active", detail: "Sample detail for Audit Management" },
    { id: "2", title: "Audit Management Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Audit Management</Text>

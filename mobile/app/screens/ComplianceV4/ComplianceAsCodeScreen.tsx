...
export default function ComplianceAsCodeScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Compliance as Code Item 1", status: "active", detail: "Sample detail for Compliance as Code" },
    { id: "2", title: "Compliance as Code Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Compliance as Code</Text>

...
export default function DataResidencyScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Data Residency Item 1", status: "active", detail: "Sample detail for Data Residency" },
    { id: "2", title: "Data Residency Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Data Residency</Text>

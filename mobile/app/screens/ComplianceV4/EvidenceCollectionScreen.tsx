...
export default function EvidenceCollectionScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Evidence Collection Item 1", status: "active", detail: "Sample detail for Evidence Collection" },
    { id: "2", title: "Evidence Collection Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

...
export default function CommunicationHubScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Communication Hub Item 1", status: "active", detail: "Sample detail for Communication Hub" },
    { id: "2", title: "Communication Hub Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

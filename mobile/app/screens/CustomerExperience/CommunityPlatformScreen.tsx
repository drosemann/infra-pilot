...
export default function CommunityPlatformScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Community Platform Item 1", status: "active", detail: "Sample detail for Community Platform" },
    { id: "2", title: "Community Platform Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Community Platform</Text>

...
export default function KnowledgeBaseScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Knowledge Base Item 1", status: "active", detail: "Sample detail for Knowledge Base" },
    { id: "2", title: "Knowledge Base Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

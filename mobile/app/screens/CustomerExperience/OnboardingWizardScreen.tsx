...
export default function OnboardingWizardScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Onboarding Wizard Item 1", status: "active", detail: "Sample detail for Onboarding Wizard" },
    { id: "2", title: "Onboarding Wizard Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

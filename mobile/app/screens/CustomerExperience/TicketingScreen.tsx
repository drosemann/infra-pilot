...
export default function TicketingScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Ticketing System Item 1", status: "active", detail: "Sample detail for Ticketing System" },
    { id: "2", title: "Ticketing System Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

...
export default function DocGeneratorScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Doc Generator Item 1", status: "active", detail: "Sample detail for Doc Generator" },
    { id: "2", title: "Doc Generator Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

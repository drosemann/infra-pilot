...
export default function ScorecardsScreen() {
  const [data, setData] = useState([
    { id: "1", title: "DORA Scorecards Item 1", status: "active", detail: "Sample detail for DORA Scorecards" },
    { id: "2", title: "DORA Scorecards Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>DORA Scorecards</Text>

...
export default function ServiceCatalogScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Service Catalog Item 1", status: "active", detail: "Sample detail for Service Catalog" },
    { id: "2", title: "Service Catalog Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (

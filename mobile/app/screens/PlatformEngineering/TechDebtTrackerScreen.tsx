...
export default function TechDebtTrackerScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Tech Debt Tracker Item 1", status: "active", detail: "Sample detail for Tech Debt Tracker" },
    { id: "2", title: "Tech Debt Tracker Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Tech Debt Tracker</Text>

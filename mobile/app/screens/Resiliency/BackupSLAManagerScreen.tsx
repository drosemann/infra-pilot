...
export default function BackupSLAManagerScreen() {
  const [data, setData] = useState([
    { id: "1", title: "Backup SLA Manager Item 1", status: "active", detail: "Sample detail for Backup SLA Manager" },
    { id: "2", title: "Backup SLA Manager Item 2", status: "pending", detail: "Another sample detail" },
  ]);
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Backup SLA Manager</Text>
